...
- SSH key pair named control in your AWS account

### 1. Clone and Navigate

```bash
git clone https://github.com/Akshay2642005/terraform-eks.git
cd terraform-eks
```
...
3. **Change region**: Update aws-region and pub-availability-zone
...
**Important**: Always run terraform destroy after your session to avoid unexpected charges.
...
- Check Terraform logs: terraform apply -var-file=\eks/dev.tfvars\ -auto-approve
